// masked.c: example of using multitexturing
// owo
...
int main(int argc, char **argv)
{
	...
	materials[0]->Texture = plTexCreate(64, 64, texture1_pixels, 256, texture1_palette);
	...
	/* create cube */
	cube = plObjCreate(NULL);
	cube->Model = plMakeBox(128, 128, 128, materials[0]);
