...
/*
   plMdlCalcBoundingBox() calculates a model's bounding box from its vertices
   Paramters:
     mdl: the model
     bbox: the bounding box to fill in
   Returns:
     nothing
*/
...
/*
  plReadPCXTex() reads an uncompressed 8bpp BMP texture
  Parameters:
