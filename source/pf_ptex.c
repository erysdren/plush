...
void plPF_MPTexF(pl_Cam *cam, pl_Face *TriFace)
{
	...
	/* draw base texture */
	plPF_PTexF(cam, TriFace);

	/* draw second texture */
	plPF_PTexF(cam, &dummyFace);
}

void plPF_MPTexG(pl_Cam *cam, pl_Face *TriFace)
{
	pl_Mat dummyMaterial;
	pl_Face dummyFace;
	...
	/* draw base texture */
	plPF_PTexG(cam, TriFace);

	/* draw second texture */
	plPF_PTexG(cam, &dummyFace);
}
